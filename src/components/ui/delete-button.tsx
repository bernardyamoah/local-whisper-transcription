...
const SURFACE = "bg-[#efeee6]";
const RECESS = "bg-[#dce7df]";
const GLYPH = "text-[#476653]";
const FOCUS = "outline-none focus-visible:ring-2 focus-visible:ring-[#476653]";
const ACCENT = "#a43f36";
...
const CIRCLE = `grid h-7 w-7 place-items-center rounded-full transition-colors duration-200 hover:bg-[#fffdf8] ${FOCUS} ${SURFACE} ${LIFT}`;
