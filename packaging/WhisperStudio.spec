...
analysis = Analysis(
    [str(project_root / "studio" / "macos.py")],
...
app = BUNDLE(
    collection,
    name="Whisper Studio.app",
    icon=str(project_root / "build" / "macos" / "WhisperStudio.icns"),
    bundle_identifier="com.bernardyamoah.whisperstudio",
    ...
    info_plist={
        ...
        "NSMicrophoneUsageDescription": "Whisper Studio records your microphone during meetings.",
        "NSSpeechRecognitionUsageDescription": "Whisper Studio creates a live local transcript while a meeting is recorded.",
        "NSScreenCaptureUsageDescription": "Whisper Studio captures meeting audio playing on your Mac.",
    },
)
